DEVELOPER: Replace occurrences of MultiParPortable in this file with the
...
user in an INI file next to MultiParPortable.exe called MultiParPortable.ini.
...
copy AppNamePortable.ini from this directory to MultiParPortable.ini next to
MultiParPortable.exe. The options in the INI file are as follows:
